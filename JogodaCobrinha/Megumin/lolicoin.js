...
const snakeHeadImageSrc = "https://static.wixstatic.com/media/1dda32_459d38341a1c44068c03b33d6ac2d83a~mv2.png/v1/fill/w_234,h_234,al_c,q_85,usm_0.33_1.00_0.00,enc_avif,quality_auto/1dda32_459d38341a1c44068c03b33d6ac2d83a~mv2.png"; // Substitua pela URL da sua imagem
const snakeHeadImage = new Image();
snakeHeadImage.src = snakeHeadImageSrc;

// URL da imagem da ficha de Lolycoin
const foodImageSrc = "https://static.wixstatic.com/media/1dda32_d3b143edf97c436cb2226cb8173e5a1d~mv2.png/v1/fill/w_234,h_234,al_c,q_85,usm_0.33_1.00_0.00,enc_avif,quality_auto/1dda32_d3b143edf97c436cb2226cb8173e5a1d~mv2.png"; // Substitua pela URL da sua imagem
...
document.getElementById("buyToken").addEventListener("click", () => {
    if (Lolicoins >= 10) {
        ...
        alert("Você não tem Lolicoins suficientes! Ganhe mais Lolicoins jogando.");
    }
});
...
// Verifica se os sons carregaram corretamente
eatSound.oncanplaythrough = () => {
    console.log("Som de comer pronto para ser tocado");
};
gameOverSound.oncanplaythrough = () => {
    console.log("Som de game over pronto");
};
scoreSound.oncanplaythrough = () => {
    console.log("Som de pontuação pronto");
};

// Verifica se as imagens carregaram corretamente
snakeHeadImage.onload = () => {
    console.log("Imagem da cabeça da cobra carregada!");
};
snakeHeadImage.onerror = () => {
    console.error("Erro ao carregar a imagem da cabeça da cobra");
};
...
foodImage.onerror = () => {
    console.error("Erro ao carregar a imagem da comida");
};
